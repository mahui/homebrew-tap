# 模板：publish-cask.sh 用 sed 替换 1.7 / 63b164a474bcb131a8190c893db26fa579bfab664df621d4b40ff385087ecdef / mahui/diskly-dist 后写入 tap 仓。
# 只引用公开发布仓与官网，绝不出现私有源码仓地址。
cask "diskly" do
  version "1.7"
  sha256 "63b164a474bcb131a8190c893db26fa579bfab664df621d4b40ff385087ecdef"
